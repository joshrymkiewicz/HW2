...
function begin_play()
{
	...
	if(document.getElementById('player1_id').value == "")
	{
		alert("Enter name for Player 1");
		return;
	}
 else if (document.getElementById('player2_id').value == "")
	{
	...
	document.getElementById('turn_info').innerHTML = "Game has started";
	started = true;
}
/*
TODO - Rule 2
...
function play()
{
	var press_play = document.getElementById("move_text_id").value;
	var invalidMove = table_ids.indexOf(press_play);
...
document.getElementById('turn_info').innerHTML = "Game has started";
	...
	if(invalidMove == -1)
		{
			alert("this is a invalid move");
			return false;
		}
	else
	{
		if(board_state[invalidMove] == 1 || 0)
			{
		...
		else
		{
				...
				if(turn == 1)
				{
						document.getElementById(press_play).innerHTML = "X";
						board_state[invalidMove] = 1;
						document.getElementById('turn_info').innerHTML = "O it is now your turn";

				}
				else
				{
					document.getElementById(press_play).innerHTML = "O";
					board_state[invalidMove] = 0;
					document.getElementById('turn_info').innerHTML = "X it is now your turn";
				}
			loadWinners();
